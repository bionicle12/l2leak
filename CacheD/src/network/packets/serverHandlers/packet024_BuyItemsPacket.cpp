...
{
// L2CacheD 0x00440FD0
bool packet024_BuyItemsPacket(CIOSocket* pSocket, const uint8_t* packet)
{
    guard(L"bool serverHandlers::packet024_BuyItemsPacket(CIOSocket *pSocket, const uint8_t *packet)");
    ...
    if (character == NULL)
    {
        ...
        serverSocket->Send("cdddddd", CacheToServerPacket_BuyItemsPacket, unknownParam1, 0, 0, 0, SellItemsResult_Error, 0);
    ...
    inventory->BuyItems(serverSocket, restOfPacket, unknownParam1);

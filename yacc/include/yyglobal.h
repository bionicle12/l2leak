...
#else
#ifdef __cplusplus
inline YYBOOL YYCDECL yygetglobaldebug()
{
    return yyglobaldebug;
}
inline void YYCDECL yysetglobaldebug(YYBOOL globaldebug)
{
    yyglobaldebug = globaldebug;
}
inline YYBOOL YYCDECL yygetglobaldebugstack()
{
    return yyglobaldebugstack;
}
inline void YYCDECL yysetglobaldebugstack(YYBOOL globaldebugstack)
{
    yyglobaldebugstack = globaldebugstack;
}
inline YYBOOL YYCDECL yygetglobaldebugflush()
{
    return yyglobaldebugflush;
}
inline void YYCDECL yysetglobaldebugflush(YYBOOL globaldebugflush)
{

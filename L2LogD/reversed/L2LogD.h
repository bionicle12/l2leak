...
/* 253 */
struct _PDH_FMT_COUNTERVALUE_MY
{
    DWORD CStatus;
    double doubleValue;
};
...
/* 194 */
struct __declspec(align(4)) PerfMonitor
{
...
{
    void(__thiscall* Release)(CPacket*, const char*, signed int, ORTs, _DWORD);
    void(__thiscall* AddRef)(MemoryObject*, const char*, signed int, signed int);
    bool(__cdecl* _vfunc010)();
    void(__thiscall* DeletingDestructor)(_DWORD, _DWORD);
...
struct __declspec(align(4)) CIOObject_Vtable
{
    ...
    void(__thiscall* OnTimer)(CIOObject*, DWORD);
    void(__thiscall* OnTimerCallback)(CIOObject*, int);
    void(__thiscall* OnWaitCallback)(CIOObject*);
    void(__stdcall* OnIOCallback)(BOOL, DWORD, LPOVERLAPPED);
    void(__thiscall* PostObject)(CIOObject*, DWORD dwNumberOfBytesTransferred);
};

/* 207 */
struct CIOServer_Vtable
{
...
struct __declspec(align(4)) CLogSocketData
{
    ...
    int m_socket;
    int field_2;
    bool(__cdecl** m_packetTable)(CLogSocket*, const unsigned __int8*);
...
/* 233 */
struct __declspec(align(4)) CServerSocketData
{
    CIOSocketData base;
    int m_socket;
    int m_buffSize;
    ...
    HANDLE m_logFiles[8];
    CRITICAL_SECTION m_fileLocks[8];
    FilePath m_fileNames[8];
    CRITICAL_SECTION m_fileLock;
    int field_1236;
};

/* 231 */
struct CServerSocket
{
    CServerSocket_Vtable* vtable;
    CServerSocketData d;
};
...
/* 238 */
struct __declspec(align(4)) CServerSocket_Vtable
{
    CIOSocket_Vtable base;
    int(__cdecl* wtf)();
    void(__thiscall* SetAddress)(CServerSocket*, in_addr);
    in_addr(__thiscall* GetAddress)(CServerSocket*, in_addr*);
};
...
struct __declspec(align(4)) CServerData
{
    ...
    HANDLE m_someHandle;
    CRITICAL_SECTION m_lock;
    CServerSocket*(__cdecl* m_allocator)(SOCKET s);
    bool m_restrict;
};
...
/* 246 */
typedef _PDH_COUNTER_PATH_ELEMENTS_W PDH_COUNTER_PATH_ELEMENTS_W;

/* 247 */
typedef _MEMORYSTATUSEX MEMORYSTATUSEX;

/* 248 */
typedef _PDH_FMT_COUNTERVALUE PDH_FMT_COUNTERVALUE;
...
/* 261 */
typedef wchar_t* names[1000];

/* 262 */
typedef wchar_t* Stack[1000];
...
{
    DIALOG_ABOUT = 0x67,
    DIALOG_LOGDB_LOGIN = 0x82,
    DIALOG_CONFIGURATION = 0x84,
    DIALOG_BBS_LOGIN = 0x85,
...
enum UI_Controls
{
    ...
    CONTROL_LOGDB_LOGIN_EDIT_BOX_PASSWORD = 0x3EA,
    CONTROL_CONFIGURATION_EDIT_BOX_BCP_LOG_INTERVAL = 0x3EB,
    CONTROL_CONFIGURATION_EDIT_BOX_SERVER_REPORT_INTERVAL = 0x3EC,
    CONTROL_CONFIGURATION_CHECK_BOX_BCP_ON = 0x3EE,
    CONTROL_BBS_LOGIN_EDIT_BOX_FILE_DB = 0x3F1,
    CONTROL_BBS_LOGIN_EDIT_BOX_LOGIN_NAME = 0x3F2,
    CONTROL_BBS_LOGIN_EDIT_BOX_PASSWORD = 0x3F3,
...
/* 289 */
struct std::priority_queue_CIOTimer
{

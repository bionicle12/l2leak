...
void PwdCrypt::EncPwdL2(char* password)  // L2AuthD 0x0043AB0C
{
    char temp = 0;
    int tempHash[4];
    char hash[16];
...
void PwdCrypt::EncPwdShalo(char* password)  // L2AuthD 0x0043AA2B
{
    char temp = 0;
    int tempHash[4];
    char hash[16];
...
void PwdCrypt::EncPwdDev(char*)  // L2AuthD 0x0043ABED
{
}

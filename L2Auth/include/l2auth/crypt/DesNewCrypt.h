...
public:
    ...
    void DesKeyInit(const char* stringKey);    // L2AuthD 0x0040A10F
    void DesWriteBlock(char* data, int size);  // L2AuthD 0x0040A07D
    void DesReadBlock(char* data, int size);   // L2AuthD 0x0040A0C6
